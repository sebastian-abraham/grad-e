...
import { Users, BookOpen, GraduationCap, LayoutDashboard, LogOut, ClipboardList, Menu, X, ChevronDown } from "lucide-react";
      ...
      <main className="main-area">
        ...
        >
          <div className="topbar-left">
            ...
            <span className="topbar-breadcrumb">Admin Panel</span>
          </div>
          ...
          <div className="topbar-right" ref={profileMenuRef}>
            ...
            >
              ...
              <span className="topbar-profile-name">{currentUser?.displayName || "Admin"}</span>
              <ChevronDown size={14} />
            </button>
